...
export type ItemMetaDataKeys = 'name' | 'description' | 'image' | 'status' | 'amount' | 'technical_assigment' | 'starting_unix_time' | 'ending_unix_time' | 'creation_unix_time' | 'category' | 'customer_addr';
...
const itemOnChainMetadataSpec: {
  ...
  status: 'utf8',
  amount: 'utf8',
  technical_assigment: 'ascii',
  starting_unix_time: 'utf8',
  ending_unix_time: 'utf8',
  creation_unix_time: 'utf8',
  category: 'utf8',
  customer_addr: 'utf8',
};
